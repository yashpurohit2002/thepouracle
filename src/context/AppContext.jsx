...
import { saveSession, loadSession, clearSession as storageClear, getUnlockedAchievements, addUnlockedAchievement } from '../lib/storage'
...
export function AppProvider({ children }) {
  ...
  async function loadInitialData(sessionId) {
    const [drinksRes, playersRes, achRes] = await Promise.all([
  ...
  function setupSubscriptions(sessionId) {
    ...
    return [drinksChannel, playersChannel, achChannel]
  }
